...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    //set the manual drive command to the default command for the subsystem
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("LeftEncoder", drivetrain.getLeftDistance());
    SmartDashboard.putNumber("RightEncoder", drivetrain.getRightDistance());
